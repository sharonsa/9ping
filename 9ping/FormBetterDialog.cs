...
namespace ninePing
{
    ...
    /// </summary>
    public partial class FormBetterDialog : Form
    {
        /// <summary>
        ...
        static public DialogResult ShowDialog(string title, string largeHeading, string smallExplanation,
            string leftButton, string middleButton, string rightButton, Image iconSet)
        {
            using (FormBetterDialog dialog = new FormBetterDialog(title, largeHeading, smallExplanation, leftButton,
                middleButton, rightButton, iconSet))
            {
        ...
        /// </summary>
        private FormBetterDialog(string title, string largeHeading, string smallExplanation,
            string leftButton, string middleButton, string rightButton, Image iconSet)
        {
            ...
            using (Graphics graphics = this.CreateGraphics())
            {
                ...
                else
                {
                    ...
                    this.Width = (int)bigSize.Width + 200;
                }
            }
            ...
            this.buttonMiddle.Text = middleButton;
            this.buttonRight.Text = rightButton;
            this.AcceptButton = buttonLeft;
            this.CancelButton = buttonMiddle;
